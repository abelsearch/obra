...
function agregar_iconos(){
	...
	var excel = '<li class="#81c784 green lighten-2"><a class="tooltipped"id="icono_excel" data-position="left" data-tooltip="Adjuntar desde Excel"><i class="material-icons">cloud_upload</i></a></li>';
	return excel;
    };
