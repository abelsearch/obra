<?php
  ...
  if($_POST)
	...
	try{
	$stmt=$db_con->prepare("INSERT INTO compra_cancelada(id,id_orden,fecha,nombre,comentarios)
		...
		{  
			...
			try{
				$stmt2=$db_con->prepare("UPDATE compras SET estatus = 'CANCELADA' WHERE id = '$id'");
