...
function agregar_iconos(){
	...
	function breadcrumb(){
	var nuevo = '<li><a data-position="left">INSUMOS</a></li>';
	return nuevo;
    };
	...
	var nuevo = '<li><a class="tooltipped"id="icono_nuevo" data-position="left" data-tooltip="Nuevo Insumo"><i class="material-icons">add_circle</i></a></li>';
	return nuevo;
    };
