...
<html>
  ...
  <body>  
    ...
    <div id="buttons">
    <button class="btn modal-trigger #757575 grey darken-1 z-depth-5 tooltipped" data-position="top" data-tooltip="Crear Nuevo Servicio" id="trigger"  href="#modal1">
    ...
    <!--<tr>-->
      ...
      <a id="<?php echo $row['id']; ?>" class='ver modal-trigger trigger tooltipped' data-position="top" data-tooltip="Ver" href="#">
  ...
  ?>   
        ...
        <div id="modal1" class="modal">
          <div class="modal-content"> 
              ...
              <button class="btn waves-effect waves-light #757575 grey darken-1 z-depth-5" type="submit" id="enviar" name="action">Submit
