<div id="modal2" class="modal">
      <div class="modal-content #eeeeee grey lighten-3">
        ...
        <a class="tooltipped" id="trigger6" data-tooltip="Nuevo Insumo"><i class="material-icons">add_circle</i></a>
        </div>
          <div class="col l4 m12 s12">
            <label>Fecha</label>
            <input id="fecha_insumo" type="text" class="datepicker"><br>
          </div>
          <div class="col l4 m12 s12">
            ...
            <select id="insumo_catalogo" class="browser-default" required onChange="insumos();">
              ...
              {
              ?>
              <option  value="<?php echo $row['id'];?>"> <?php echo $row['nombre'];?> - Unidad de medida <?php echo $row['unidad'];?></option>
              <?php
              }
              ?>
            </select>
          ...
          <div class="col l4 m12 s12">
            ...
            <input id="insumo_nuevo_input"type="text" disabled>
          </div>
          <div class="col l4 m12 s12">
