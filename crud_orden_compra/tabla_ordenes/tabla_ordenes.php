<div class="row" style="margin-left: 100px">
  <div class="col m12">
    <div id="title">
      <h2 class="form-signin-heading" style="font: 150% sans-serif;">Ordenes De Compra</h2>
    </div>
      ...
      <thead class=""style="background-color:#ff9955">
        ...
        <tbody>
          ...
          $stmt=$db_con->prepare("SELECT orden_compra.id_proveedor, proveedor.nombre AS nombre, orden_compra.folio AS folio,
             ...
             FROM orden_compra INNER JOIN proveedor ON orden_compra.id_proveedor=proveedor.id WHERE orden_compra.estatus = 'APROBADA' OR orden_compra.estatus = 'PEDIDO' ORDER BY id_compra DESC");
          $stmt->execute();
