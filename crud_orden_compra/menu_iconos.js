...
function agregar_iconos(){
	...
	var nuevo_insumo = '<li style="background-color:#10ac84"><a class="tooltipped"id="insumo_nuevo" data-position="left" data-tooltip="Nuevo Insumo"><i class="material-icons">add_circle</i></a></li>';
	return nuevo_insumo;
    };
